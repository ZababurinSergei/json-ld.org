!function (a) {
    ...
    function d(a, b) {
        ...
        return b = c(b || ''), a = c(a || ''), b && a ? (b.protocol || a.protocol) + (b.protocol || b.authority ? b.authority : a.authority) + d(b.protocol || b.authority || '/' === b.pathname.charAt(0) ? b.pathname : b.pathname ? (a.authority && !a.pathname ? '/' : '') + a.pathname.slice(0, a.pathname.lastIndexOf('/') + 1) + b.pathname : a.pathname) + (b.protocol || b.authority || b.pathname ? b.search : b.search || a.search) + b.hash : null;
    }
    ...
    function f(a, b) {
        if (a && 'object' == typeof a) {if (void 0 === b ? b = a.id : 'string' == typeof a.id && (b = d(b, a.id), a.id = b), Array.isArray(a)) {for (var c = 0; c < a.length; c++) {f(a[c], b);}} else {
    ...
    function i(a) {
        var b = new j, c = a || 'en', g = {
            addFormat: function () {
                ...
                'string' == typeof d && (d = {$ref: d}), g.addSchema('', d), g.validateAll(a, d, null, null, ''), f && g.banUnknownProperties();
                var h = {};
    ...
    j.prototype.defineKeyword = function (a, b) {
        ...
        (a = e(a) + '#') && (a = e(a)), this.schemas[a] = b, delete this.missingMap[a], f(b, a), this.searchSchemas(b, a);
        ...
        if (this.checkRecursive && a && 'object' == typeof a) {
            ...
            if (this.scanned.push(a), Object.isFrozen(a)) {-1 === h && (h = this.scannedFrozen.length, this.scannedFrozen.push(a), this.scannedFrozenSchemas.push([])), j = this.scannedFrozenSchemas[h].length, this.scannedFrozenSchemas[h][j] = b, this.scannedFrozenValidationErrors[h][j] = [];} else {
                if (!a[this.validatedSchemasKey]) {try {
                    Object.defineProperty(a, this.validatedSchemasKey, {
                        value: [],
                        configurable: !0
                    }), Object.defineProperty(a, this.validationErrorsKey, {value: [], configurable: !0});
                } catch (n) {
        ...
        var o = this.errors.length,
            p = this.validateBasic(a, b, e) || this.validateNumeric(a, b, e) || this.validateString(a, b, e) || this.validateArray(a, b, e) || this.validateObject(a, b, e) || this.validateCombinations(a, b, e) || this.validateFormat(a, b, e) || this.validateDefinedKeywords(a, b, e) || null;
        if (f) {
        ...
        return 'string' == typeof c || 'number' == typeof c ? this.createError(k.FORMAT_CUSTOM, {message: c}).prefixWith(null, 'format') : c && 'object' == typeof c ? this.createError(k.FORMAT_CUSTOM, {message: c.message || '?'}, c.dataPath || null, c.schemaPath || '/format') : null;
        ...
        for (var c in this.definedKeywords) {for (var d = this.definedKeywords[c], e = 0; e < d.length; e++) {
            ...
            if (g && 'object' == typeof g) {
                ...
                var i = 'object' == typeof g.message ? g.message : {key: c, message: g.message || '?'},
        ...
        return void 0 === c ? null : 'number' == typeof a && a % c !== 0 ? this.createError(k.NUMBER_MULTIPLE_OF, {
            value: a,
            multipleOf: c
        }) : null;
        ...
        if (void 0 !== b.minimum) {
            if (a < b.minimum) {return this.createError(k.NUMBER_MINIMUM, {
                value: a,
                minimum: b.minimum
        ...
        if (void 0 !== b.maximum) {
            if (a > b.maximum) {return this.createError(k.NUMBER_MAXIMUM, {
                value: a,
                maximum: b.maximum
        ...
        return 'string' != typeof a ? null : void 0 !== b.minLength && a.length < b.minLength ? this.createError(k.STRING_LENGTH_SHORT, {
            length: a.length,
            minimum: b.minLength
        }).prefixWith(null, 'minLength') : void 0 !== b.maxLength && a.length > b.maxLength ? this.createError(k.STRING_LENGTH_LONG, {
            length: a.length,
            maximum: b.maxLength
        ...
        var c;
        return void 0 !== b.minItems && a.length < b.minItems && (c = this.createError(k.ARRAY_LENGTH_SHORT, {
            length: a.length,
            minimum: b.minItems
        }).prefixWith(null, 'minItems'), this.handleError(c)) ? c : void 0 !== b.maxItems && a.length > b.maxItems && (c = this.createError(k.ARRAY_LENGTH_LONG, {
                length: a.length,
                maximum: b.maxItems
        ...
        if (Array.isArray(b.items)) {
            for (e = 0; e < a.length; e++) {if (e < b.items.length) {
                ...
                if (!b.additionalItems && (d = this.createError(k.ARRAY_ADDITIONAL_ITEMS, {}).prefixWith('' + e, 'additionalItems'), this.handleError(d))) {return d;}
        ...
        return void 0 !== b.minProperties && d.length < b.minProperties && (c = this.createError(k.OBJECT_PROPERTIES_MINIMUM, {
            propertyCount: d.length,
            minimum: b.minProperties
        }).prefixWith(null, 'minProperties'), this.handleError(c)) ? c : void 0 !== b.maxProperties && d.length > b.maxProperties && (c = this.createError(k.OBJECT_PROPERTIES_MAXIMUM, {
                propertyCount: d.length,
        ...
        if (void 0 !== b.required) {for (var c = 0; c < b.required.length; c++) {
            var d = b.required[c];
            if (void 0 === a[d]) {
                var e = this.createError(k.OBJECT_REQUIRED, {key: d}).prefixWith(null, '' + c).prefixWith(null, 'required');
        ...
        for (var e in a) {
            ...
            if (g) {this.trackUnknownProperties && (this.knownPropertyPaths[f] = !0, delete this.unknownPropertyPaths[f]);} else if (void 0 !== b.additionalProperties) {
                if (this.trackUnknownProperties && (this.knownPropertyPaths[f] = !0, delete this.unknownPropertyPaths[f]), 'boolean' == typeof b.additionalProperties) {
                    if (!b.additionalProperties && (d = this.createError(k.OBJECT_ADDITIONAL_PROPERTIES, {}).prefixWith(e, 'additionalProperties'), this.handleError(d))) {return d;}
        ...
        if (void 0 !== b.dependencies) {for (var e in b.dependencies) {if (void 0 !== a[e]) {
            ...
            if ('string' == typeof f) {
                if (void 0 === a[f] && (d = this.createError(k.OBJECT_DEPENDENCY_KEY, {
                    key: e,
                    missing: f
                ...
                var h = f[g];
                if (void 0 === a[h] && (d = this.createError(k.OBJECT_DEPENDENCY_KEY, {
                    key: e,
                    missing: h
        ...
        return this.trackUnknownProperties && (this.unknownPropertyPaths = d, this.knownPropertyPaths = e), h ? (f = f.concat(this.errors.slice(g)), this.errors = this.errors.slice(0, g), this.createError(k.ANY_OF_MISSING, {}, '', '/anyOf', f)) : void 0;
        ...
        return this.trackUnknownProperties && (this.unknownPropertyPaths = d, this.knownPropertyPaths = e), null === f ? (g = g.concat(this.errors.slice(h)), this.errors = this.errors.slice(0, h), this.createError(k.ONE_OF_MISSING, {}, '', '/oneOf', g)) : (this.errors = this.errors.slice(0, h), null);
        ...
        return this.errors = this.errors.slice(0, f), this.trackUnknownProperties && (this.unknownPropertyPaths = d, this.knownPropertyPaths = e), null === g && 0 === h.length ? this.createError(k.NOT_PASSED, {}, '', '/not') : null;
    };
    var k = {
            INVALID_TYPE: 0,
            ENUM_MISMATCH: 1,
    ...
    g.prototype = Object.create(Error.prototype), g.prototype.constructor = g, g.prototype.name = 'ValidationError', g.prototype.prefixWith = function (a, b) {
    ...
    var o = {}, p = i();
    p.addLanguage('en-gb', n), p.tv4 = p, 'undefined' != typeof module && module.exports ? module.exports = p : a.tv4 = p;
}(this);
